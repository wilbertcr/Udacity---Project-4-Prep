...
class HelloWorldApi(remote.Service):
    ...
    @endpoints.method(
                      # This is the request message type(the one sent to the server)
                      REQUEST_GREETING_CONTAINER,
                      # This is the returned message type(the one sent to the client)
                      Hello,
                      # Path defines the path of this endpoint, relative to the APi's name.
                      path="greetByPeriod",
                      # Self explanatory.
                      http_method='GET',
                      #
